<template>
  <div class="playground-container">
    ...
    <div
      ...
      :class="{ 'vertical-layout': isVerticalLayout || isMobileScreen }"
    >
      <!-- Input Section -->
      <div class="input-section">
        ...
        <div class="input-controls">
          ...
          <button @click="processInput" class="button ac-button is-primary">Re-Generate</button>
        </div>
        <textarea
          v-model="inputContent"
          :placeholder="`Write ${inputType}`"
          class="input-area"
        ></textarea>
      </div>
